...
tree <- rpart(trimmed_activity ~ ., data = training_df, minsplit = 10, cp = .005) # cp = complexity parameter
...
library(C50)
treeModel <- C5.0(x = training_df[, -11], y = training_df$trimmed_activity)
treeModel
summary(treeModel)
plot(treeModel, subtree = 's94')
C50::C5imp(treeModel,pct = T)
```
