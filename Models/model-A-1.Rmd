...
## Linear imputation, X,Y,Z

In this markdown, we use the linear imputed data. Only **X, Y, and Z-axis** variables are used for this model. We apply the following models using the `ApplyModels` function from `BEAP` package:
