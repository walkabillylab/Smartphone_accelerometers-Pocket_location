...
In this markdown, we use the linear imputed data. **X,Y,Z, and metadata** variables are used for this model. We apply the following models using the `ApplyModels` function from `BEAP` package:
