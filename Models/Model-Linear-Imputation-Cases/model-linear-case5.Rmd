...
## reading
Here we just read the data that is prevously prepared instead of creating the dataset from the beginning
...
working_df <- fread(paste0(main_path,"/Ethica_Jaeger_Merged/Linear_xyz_counts_feaatures.csv"))
