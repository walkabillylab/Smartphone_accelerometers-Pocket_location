...
## Linear imputation, X,Y,Z, and Counts

In this markdown, we use the linear imputed data. **X,Y,Z, and Counts** variables are used for this model. We apply the following models using the `ApplyModels` function from `BEAP` package:
...
working_df %<>%  dplyr::select(c(x_axis, y_axis, z_axis, x, y, z, trimmed_activity))
