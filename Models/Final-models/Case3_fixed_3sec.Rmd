---
title: "Case 3- fixed leakage_3 sec "
...
In this file we try to fix the high accuracy problem. I think having repeated values are the main problem. We have many feature(+60) and we repeated rows many times and this rows are almost identical( only different in 3 features). This produced high accuracy as the model has seen most of the data before.
...
# Add new features
This time we use **three Seconds**
