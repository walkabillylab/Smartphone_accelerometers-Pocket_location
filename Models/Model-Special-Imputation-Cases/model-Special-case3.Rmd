...
## Special imputation, X,Y,Z, and metadata

In this markdown, we use the Special imputed data. **X,Y,Z, and metadata** variables are used for this model. We apply the following models using the `ApplyModels` function from `BEAP` package:
