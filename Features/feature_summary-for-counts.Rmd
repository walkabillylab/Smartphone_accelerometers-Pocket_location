...
If we use a window size of 2 second, these feature have a sd of zero therfore, we need to eliminate these features in final Case 4 as they don't carry any usable information. However, it is bettter to increase window size to solve this issue.
...
<!-- ```{r trimFeatures, eval=FALSE, include=FALSE} -->
<!-- working_df %<>%  select(-c( -->
<!-- acf_x, -->
<!-- acf_y, -->
<!-- acf_z, -->
