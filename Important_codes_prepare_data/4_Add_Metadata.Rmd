...
```{r}
# used for 30Hz, change to Ethica_jaeger_merged.csv for 10Hz
df <- fread("Ethica_Jaeger_Merged/Ethica_jaeger_merged_30Hz.csv")
...
setwd(path)
# change for 10 HZ
fwrite(final_data_frame,file = "Ethica_jaeger_merged_metadata_30Hz.csv")
```



By default we don't run the following codes (eval = False)
